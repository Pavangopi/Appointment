...
<body>
	...
	<h2 class="w3-center">Appointment Form</h2>
        ...
        <table align="center" width=40% width="100%" cellspacing="2" cellpadding="2" border="5">
            ...
            <tr>
              ...
              <tr>
                ...
                <td width="57%"><select name="doctor" >
                ...
                <td width="57%"><input type="date" value="" name="date" size="24" required></td>
            </tr>
            <tr>
            ...
            <td width="57%">
                <input type="text" value="" onkeypress="return isNumber(event)" name="age" placeholder="Enter Patient Age" size="24" required></td>
            </tr>
